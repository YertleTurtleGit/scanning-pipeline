      ...
      return new Promise((resolve) => {
         setTimeout(async () => {
            ...
            const lightLuminances = [
               ...
               new GLSL.Image(lightImage_045).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_090).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_135).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_180).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_225).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_270).getPixelColor().getLuminance(),
               new GLSL.Image(lightImage_315).getPixelColor().getLuminance(),
            ];
