...
async function main() {
   ...
   const normalizeNode = nodeGraph.registerNodeAsWorker(
      normalize,
      ["./src/glsl-shader.js", "./src/basic-image-operations.js"],
      NODE_TYPE.IMAGE
   );

   const normalizeNodeA = nodeGraph.placeNode(normalizeNode, { x: 450, y: 25 });
